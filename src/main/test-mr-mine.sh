...
../mrsequential ../../mrapps/wc.so ../pg_files/pg*txt || exit 1
sort mr-out-0 > mr-correct-wc.txt
rm -f mr-out*

echo '***' Starting wc test.

timeout -k 2s 180s ../mrmaster ../pg_files/pg*txt &
...
sort mr-out* | grep . > _mr-wc-all
if cmp _mr-wc-all mr-correct-wc.txt
then
  echo '---' wc test: PASS
else
...
# generate the correct output
../mrsequential ../../mrapps/indexer.so ../pg_files/pg*txt || exit 1
...
# generate the correct output
../mrsequential ../../mrapps/nocrash.so ../pg_files/pg*txt || exit 1
...
rm -f mr-done
(timeout -k 2s 180s ../mrmaster ../pg_files/pg*txt ; touch mr-done ) &
sleep 1
